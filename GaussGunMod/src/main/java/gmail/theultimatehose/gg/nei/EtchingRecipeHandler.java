...
public class EtchingRecipeHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals(this.getName()) && getClass() == EtchingRecipeHandler.class) {
            arecipes.add(new CachedEtching(new ItemStack(Main.pcbUnetched), new ItemStack(Main.pcbEtched), new ItemStack(Main.bucketAcid)));
        } else {
    ...
    public void loadCraftingRecipes(ItemStack result) {
        if (result.getItem() == Main.pcbEtched) {
            arecipes.add(new CachedEtching(new ItemStack(Main.pcbUnetched), new ItemStack(Main.pcbEtched), new ItemStack(Main.bucketAcid)));
        }
    }
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        if (ingredient.getItem() == Main.bucketAcid || ingredient.getItem() == Main.pcbUnetched) {
            arecipes.add(new CachedEtching(new ItemStack(Main.pcbUnetched), new ItemStack(Main.pcbEtched), new ItemStack(Main.bucketAcid)));
        }
    }
    ...
    public String getGuiTexture() {
        return "gg:textures/gui/guiMAD.png";
    }
