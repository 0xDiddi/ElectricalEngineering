...
import gmail.theultimatehose.gg.config.values.CfgFloatValues;
...
public class BlockBurntMachine extends Block {
    ...
    public void registerBlockIcons(IIconRegister iconReg) {
        this.topIcon = iconReg.registerIcon("gg:burntMachineTop");
        this.sideIcon = iconReg.registerIcon("gg:burntMachineSide");
