...
public class EntityBolt extends Entity implements IProjectile {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    if (this.shootingEntity == null) {
                        ...
                        damagesource = new EntityDamageSourceIndirect("bolt", this, this.shootingEntity).setProjectile();
                    }
    ...
    public void writeEntityToNBT(NBTTagCompound p_70014_1_) {
        p_70014_1_.setShort("xTile", (short) this.x);
        p_70014_1_.setShort("yTile", (short) this.y);
        p_70014_1_.setShort("zTile", (short) this.z);
    ...
    public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
        this.x = p_70037_1_.getShort("xTile");
        this.y = p_70037_1_.getShort("yTile");
        this.z = p_70037_1_.getShort("zTile");
