...
public class BlockMAD extends BlockContainerExt {
    ...
    public void registerBlockIcons(IIconRegister iconReg) {
        this.topIcon = iconReg.registerIcon("electricalengineering:madTop");
        this.sideIcon = Blocks.iron_block.getIcon(0, 0);
        this.frontIcon = iconReg.registerIcon("electricalengineering:madFront");
        this.backIcon = iconReg.registerIcon("electricalengineering:madBack");
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        if (!world.isRemote) {
            ...
            if (mad != null) player.openGui(ElectricalEngineering.instance, GuiHandler.MAD_ID, world, x, y, z);
        }
        return true;
    }
}
