...
import theultimatehose.electricalengineering.model.PcbFrameBlockRenderer;
import theultimatehose.electricalengineering.network.PacketHandler;
import theultimatehose.electricalengineering.proxy.CommonProxy;
import theultimatehose.electricalengineering.recipe.SolderRecipe;
...
public class ElectricalEngineering {
    ...
    public void init(FMLInitializationEvent e) {
        ...
        if (Loader.isModLoaded("GaussGun"))
